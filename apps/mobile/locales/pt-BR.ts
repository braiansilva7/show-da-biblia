export const ptBR = {
  ...
  highestLevel: 'Maior nível liberado',
  ...
  gameStartError: 'Não foi possível iniciar a partida. Verifique sua conexão e tente novamente.',
  ...
  jokerReveal: 'Chamar universitários',
