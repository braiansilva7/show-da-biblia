...
const styles = StyleSheet.create({
  content: { gap: theme.spacing.md, paddingBottom: theme.spacing.xl, paddingTop: theme.spacing.sm },
  metrics: { backgroundColor: theme.colors.surfaceAccent, borderRadius: theme.radius.md, flexDirection: 'row', gap: theme.spacing.xs, padding: theme.spacing.xs }, metricCard: { alignItems: 'center', backgroundColor: theme.colors.surface, borderRadius: theme.radius.sm, flex: 1, gap: 3, minHeight: 82, justifyContent: 'center', padding: theme.spacing.xs, ...theme.shadow.card }, timeExpired: { backgroundColor: theme.colors.errorSurface, borderColor: theme.colors.error, borderWidth: 1 }, metricLabel: { color: theme.colors.mutedText, fontSize: 11 }, metricValue: { color: theme.colors.text, fontSize: 15, fontWeight: '900' },
  question: { backgroundColor: theme.colors.surfaceAccent, borderLeftColor: theme.colors.secondary, borderLeftWidth: 4, borderRadius: theme.radius.md, color: theme.colors.text, fontSize: 22, fontWeight: '800', lineHeight: 31, padding: theme.spacing.md }, answers: { gap: theme.spacing.sm }, answer: { alignItems: 'center', backgroundColor: theme.colors.surface, borderColor: theme.colors.border, borderRadius: theme.radius.md, borderWidth: 1, flexDirection: 'row', gap: theme.spacing.sm, justifyContent: 'space-between', minHeight: theme.layout.touchTarget + 12, padding: theme.spacing.md, ...theme.shadow.card }, answerText: { color: theme.colors.text, flex: 1, fontSize: 16, lineHeight: 22 }, correct: { backgroundColor: theme.colors.successSurface, borderColor: theme.colors.success }, wrong: { backgroundColor: theme.colors.errorSurface, borderColor: theme.colors.error }, explanation: { backgroundColor: theme.colors.successSurface, borderBottomLeftRadius: theme.radius.md, borderBottomRightRadius: theme.radius.md, marginTop: -theme.spacing.sm, padding: theme.spacing.md, paddingTop: theme.spacing.lg }, explanationTitle: { color: theme.colors.success, fontWeight: '800', marginBottom: 4 }, explanationText: { color: theme.colors.text, lineHeight: 20 },
  actions: { gap: theme.spacing.sm }, actionCard: { alignItems: 'center', backgroundColor: theme.colors.surface, borderColor: theme.colors.border, borderRadius: theme.radius.md, borderWidth: 1, flexDirection: 'row', gap: theme.spacing.md, minHeight: 72, padding: theme.spacing.md, ...theme.shadow.card }, actionText: { flex: 1 }, actionLabel: { color: theme.colors.text, fontSize: 16, fontWeight: '800' }, actionDetail: { color: theme.colors.mutedText, fontSize: 13, marginTop: 2 }, cardDisabled: { opacity: 0.45 }, cardPressed: { transform: [{ scale: 0.99 }] }, error: { color: theme.colors.error },
});
